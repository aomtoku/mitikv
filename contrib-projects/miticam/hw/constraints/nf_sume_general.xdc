...
# 200MHz Memory Clock 
#set_property -dict { PACKAGE_PIN AD32 VCCAUX_IO DONTCARE IOSTANDARD DIFF_SSTL15 } [get_ports  mem0_clk_p];
#set_property -dict { PACKAGE_PIN AD33 VCCAUX_IO DONTCARE IOSTANDARD DIFF_SSTL15 } [get_ports  mem0_clk_n];
#create_clock -add -name mem0_clk_p -period 5.00 -waveform {0.000 2.500} [get_ports mem0_clk_p];
#
#set_property -dict { PACKAGE_PIN AU14 VCCAUX_IO DONTCARE IOSTANDARD DIFF_SSTL15 } [get_ports  mem1_clk_p];
#set_property -dict { PACKAGE_PIN AU13 VCCAUX_IO DONTCARE IOSTANDARD DIFF_SSTL15 } [get_ports  mem1_clk_n];
#create_clock -add -name mem1_clk_p -period 5.00 -waveform {0.000 2.500} [get_ports mem1_clk_p];

#set_property -dict { PACKAGE_PIN AU14 VCCAUX_IO DONTCARE IOSTANDARD DIFF_SSTL15 } [get_ports  mem_clk_p];
#set_property -dict { PACKAGE_PIN AU13 VCCAUX_IO DONTCARE IOSTANDARD DIFF_SSTL15 } [get_ports  mem_clk_n];
#create_clock -add -name mem_clk_p -period 5.00 -waveform {0.000 2.500} [get_ports mem_clk_p];
...
#set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets mem0_clk]
