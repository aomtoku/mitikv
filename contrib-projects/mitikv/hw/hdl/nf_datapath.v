...
(
 ...
 input_arbiter_v1_0 (
      ...
      .m_axis_tdata (s_axis_memc_tdata), 
      .m_axis_tkeep (s_axis_memc_tkeep), 
      .m_axis_tuser (s_axis_memc_tuser), 
      .m_axis_tvalid(s_axis_memc_tvalid), 
      .m_axis_tready(s_axis_memc_tready), 
      .m_axis_tlast (s_axis_memc_tlast), 
