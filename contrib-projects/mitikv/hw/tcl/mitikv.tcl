...
#generate_target {instantiation_template} [get_files axis_switch_0.xci]
#generate_target all [get_files axis_switch_0.xci]
#
#create_ip -name axis_switch -vendor xilinx.com -library ip -version 1.1 -module_name mem_switch_0
...
#generate_target {instantiation_template} [get_files mem_switch_0.xci]
#generate_target all [get_files mem_switch_0.xci]
