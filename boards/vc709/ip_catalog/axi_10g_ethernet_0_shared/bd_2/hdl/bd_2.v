...
(* CORE_GENERATION_INFO = "bd_2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_2,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,synth_mode=Global}" *) (* HW_HANDOFF = "axi_10g_ethernet_0_shared.hwdef" *) 
module bd_2
   (areset,
    areset_coreclk,
    coreclk,
  ...
  bd_2_dcm_locked_driver_0 dcm_locked_driver
       (.dout(dcm_locked_driver_dout));
  bd_2_pma_pmd_type_driver_0 pma_pmd_type_driver
       (.dout(pma_pmd_type_driver_dout));
  bd_2_ten_gig_eth_mac_0 ten_gig_eth_mac
  ...
  bd_2_ten_gig_eth_pcs_pma_0 ten_gig_eth_pcs_pma
       (.areset(areset_1),
